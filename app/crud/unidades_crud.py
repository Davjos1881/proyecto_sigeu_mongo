...
def _convert_facultad(u):
    if u.facultad:
        return {
            "id_facultad": str(u.facultad.id_facultad) if u.facultad.id_facultad else None,
            "nombre_facultad": u.facultad.nombre_facultad
        }
    return None
